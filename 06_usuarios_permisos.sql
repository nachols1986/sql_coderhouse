...
-- Conceder permisos de solo lectura en todas las tablas del marketplace_db
...
-- Conceder permisos de lectura, inserción y modificación en todas las tablas del marketplace_db
-- No se permite eliminar registros
GRANT SELECT, INSERT, UPDATE ON marketplace_db.* TO
'lectura_insercion_modificacion'@'localhost';

-- Eliminar la capacidad de eliminar registros para ambos usuarios
-- Esto se aplica a nivel global
